...
\begin{enumerate}
    \item Opgave 1
    Taget fra https://www.geeksforgeeks.org/c-program-for-merge-sort/ fordi den fra moodle på ingen måde gad at virke uanset hvor meget jeg rettede i det. Den er alligevel baseret på næsten en direkt kopi af denne, så det går nok.
    \begin{lstlisting}
    #include<stdlib.h> 
    #include<stdio.h> 
